...
class EAppAntiCheatType(SteamIntEnum):
...
class EAppGameEngineType(SteamIntEnum):
...
class EStreamControlMessage(SteamIntEnum):
    ...
    EStreamControlEnableNeptuneData = 139
    EStreamControlDisableNeptuneData = 140
    EStreamControlStartNeptuneData = 141
    EStreamControlStopNeptuneData = 142
